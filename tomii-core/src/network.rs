...
//! the Τομί resolution system via lock-free SPSC channels.
//!
//! ## Architecture
//!
//! ```text
...
//! 2. Τομί creates sockets and spawns receiver threads
...
/// Network socket types supported by Τομί
#[derive(Debug, Clone)]
pub enum SocketType {
    Udp,
    // Tcp, // Future support
...
/// Receiver loop for a range of sockets (round-robin polling).
///
